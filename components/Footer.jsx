...
const Footer = () => {
    return (
        <>
            <footer>
                <div className="container mx-auto px-4 pt-10 text-white"><div className="footer-content"><div className=" container mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-4 gap-8 ">
                    <div>
                        <h3 className="text-sm font-semibold  tracking-wider mb-4">Changeons notre mo(n)de durablement</h3>
                        <p className="text-sm">Refashion est l'éco-organisme de la Filière Textile (textiles, linge de maison et chaussures).</p>
                        <p className="text-sm">Notre mission : fédérer et accompagner tous les acteurs de la production, de la consommation jusqu’à la régénération, pour réduire les impacts et créer de la valeur.</p>
                        <p className="text-sm">Notre projet : S'inscrire dans la dynamique d'une économique circulaire : mettre en place un modèle innovant et durable, moteur d’activité et de performance environnementale, économique et sociale.</p></div><div>
                        <h3 className="text-sm font-semibold tracking-wider mb-4">A propos</h3>
                        <ul className="space-y-2">
                            <li>
                                <a href="#" className="text-sm">Nous connaître</a>
                            </li>
                            <li>
                                <a href="#" className="text-sm">Nos champs d’action</a></li><li><a href="#" className="text-sm">Avis du Comité des Parties Prenantes</a>
                            </li>
                            <li>
                                <a href="#" className="text-sm">Nos actions et résultats</a></li><li><a href="#" className="text-sm">Nous Contacter</a>
                            </li>
                        </ul>
                    </div>
                    <div><h3 className="text-sm font-semibold tracking-wider mb-4">Nos sites</h3><ul className="space-y-2">
                        <li>
                            <a href="#" className="text-sm">ReFashion Pro</a>
                        </li>
                        <li><a href="#" className="text-sm">EcoDesign</a>
                        </li>
                        <li><a href="#" className="text-sm">Metteur en marché</a>
                        </li>
                        <li>
                            <a href="#" className="text-sm">Collectivité et Acteur Public</a>
                        </li>
                        <li><a href="#" className="text-sm">Opérateur</a>
                        </li>
                        <li><a href="#" className="text-sm">Réparateur</a></li>
                        <li><a href="#" className="text-sm">Plateforme Recycle</a>
                        </li>
                        <li><a href="#" className="text-sm">FAQ</a>
                        </li>
                    </ul>
                    </div>
                    <div>
                        <h3 className="text-sm font-semibold tracking-wider mb-4">Nous suivre</h3>
                        <ul className="space-y-2">
                            <li>
                    ...
                    <div className="pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
                        <p className="text-sm">©2025 Refashion</p>
                        <div className="flex space-x-6 mt-4 md:mt-0">
                            <a href="#" className="text-sm">Mentions <br />Légales</a>
                            <a href="#" className="text-sm">Conditions générales <br />d’utilisation</a>
                            <a href="#" className="text-sm">Politique de protection <br />des données personnelles</a>
                            <a href="#" className="text-sm">Politique de <br />Cookies</a>
                            <a href="#" className="text-sm">Déclaration <br />d’accessibilité</a>
                        </div>
                    </div>
                    <div className="px-20 lg:px-25 pt-50 lg:pb-10">
                        <a href="https://refashion.fr" rel="home" aria-label="Refashion, Aller à la page d’accueil" className="block opacity-50 hover:opacity-100 transition-opacity">
                            <svg xmlns="http://www.w3.org/2000/svg" width="529" height="100" fill="none" viewBox="0 0 529 100" className="fill-white w-full h-auto">
